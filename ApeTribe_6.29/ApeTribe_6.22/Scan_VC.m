...
- (void)setupMaskView
{
    ...
    mask.layer.borderColor = [UIColor colorWithWhite:0.000 alpha:0.810].CGColor;
...
//    _scanWindow.backgroundColor = [UIColor colorWithWhite:0.600 alpha:1.000];
...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection{
    if (metadataObjects.count>0) {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"扫描结果" message:metadataObject.stringValue delegate:self cancelButtonTitle:@"退出" otherButtonTitles:@"前往", nil];
        [alert show];
    }
}
#pragma mark-> 我的相册
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    {
        //[_session startRunning];
        NSString * string = self.metadataObject.stringValue;
        NSString *strId = [string substringFromIndex:24];
        
        MineViewController *mineVC = [[MineViewController alloc]initWithState:NO andUserId:[strId intValue]andOperationType:NavigationControllerOperationTypePop];
